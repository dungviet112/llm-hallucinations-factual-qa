...
uv pip install matplotlib seaborn sentencepiece evaluate einops rouge-score gputil captum python-dotenv
uv pip install accelerate
# uv pip install accelerate==0.30.0 pyvene==0.1.2 # only with pyvene
